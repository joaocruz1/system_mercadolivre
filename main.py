...
app.register_blueprint(LoginRoute(user_service=user_services).blueprint, url_prefix="/")
app.register_blueprint(DashboardRoute(services_api=services_api).blueprint, url_prefix="/")
app.register_blueprint(UsersRoute(users_service=user_services).blueprint, url_prefix="/")
